...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class( 'flex flex-col min-h-[100dvh]' ); ?>>
        ...
        <header class="flex-none px-4 sticky top-0 z-100 text-white bg-primary-600 md:px-6" role="banner">
            <div class="max-w-[var(--wp--style--global--content-size)] mx-auto">
                <div class="flex items-center gap-4 md:gap-6">
                    ...
                    <nav class="order-last lg:order-none" id="header-nav">
                        <button class="group/toggle cursor-pointer inline-flex align-top items-center justify-center w-6 h-6 rounded-sm lg:hidden" id="header-toggle" type="button">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="group-[.open]/toggle:hidden"><path d="M4 5h16"/><path d="M4 12h16"/><path d="M4 19h16"/></svg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="hidden group-[.open]/toggle:block"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
                        </button>
                        <?php 
                            wp_nav_menu( array(
                                'menu'          => 'Hlavné menu',
                    ...
                    <a href="<?php echo home_url( '/prihlasit-milacika/' ); ?>" class="flex-none ml-auto outline-accent-400 button button-sm button-accent">Prihlásiť miláčika</a>
                </div>
            </div>
        </header>