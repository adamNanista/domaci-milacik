        ...
        <div class="flex items-center gap-4 md:gap-6">
            ...
            <nav class="header-nav" id="header-nav">
                <button class="header-toggle" id="header-toggle" type="button">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="header-toggle-close lucide lucide-x-icon lucide-x hidden"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
                </button>
                <?php 
                    wp_nav_menu( array(
                        'menu'          => 'Hlavné menu',
