                            ...
                            <div class="detail-content-footer">
                                <div class="space-y-4">
                                    ...
                                    <div class="flex flex-wrap items-center gap-3">
                                        ...
                                        <a href="https://www.facebook.com/dialog/send?link=<?php the_permalink(); ?>&app_id=<?php echo FACEBOOK_APP_ID;  ?>&redirect_uri=<?php the_permalink(); ?>" class="button button-sm button-outline" target="_blank">
                                        ...
                                        <button onclick="copyToClipboard(window.location.href)" class="button button-sm button-outline" type="button">
