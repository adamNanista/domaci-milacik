		...
		<div class="grid gap-6 md:grid-cols-2">
			<div class="space-y-6 md:space-y-8">
				<div class="space-y-4 md:space-y-6">
					<h1 class="text-5xl text-uppercase md:text-7xl"><?php echo $title ? wp_kses_post($title) : 'Nadpis'; ?></h1>
					<p class="text-base md:text-xl"><?php echo $subtitle ? wp_kses_post($subtitle) : 'Podnadpis'; ?></p>
				</div>
