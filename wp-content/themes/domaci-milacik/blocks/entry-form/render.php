...
<section <?php echo get_block_wrapper_attributes( array( 'class' => 'entry-form' ) ); ?>>
    <form class="group/form grid gap-6 relative md:grid-cols-2 [&.loading]:opacity-50 [&.loading]:blur-sm" id="contest-entry-form" enctype="multipart/form-data" novalidate="novalidate">
        ...
        <div class="hidden items-center justify-center absolute inset-0 text-neutral-500 group-[.loading]/form:flex">
